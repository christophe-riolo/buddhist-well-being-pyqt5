...
class DiaryListWidget(QWidget):
    ...
    def __init__(self):
        ...
        # ..text area
        self.adding_text_to_diary_textedit_w6 = QTextEdit()
        ...
        self.adding_to_diary_date_datetimeedit_w6 = QDateTimeEdit()
        ...
        self.adding_to_diary_now_button = QPushButton("Now/Today")
    ...
    def on_context_menu_delete(self):
        message_box_reply = QMessageBox.question(
